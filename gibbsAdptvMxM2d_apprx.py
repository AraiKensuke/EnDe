        ...
        for epc in xrange(ep1, ep2):
            ...
            for itrB in xrange(iterBLOCKs):
                ...
                for itr in xrange(itrB*BLK, (itrB+1)*BLK):
                    ...
                    _cdfs2dA.smp_f(0, itr, M_use, xt0t1, clstsz, cls_str_ind, 
                                        v_sts, t0, l0, 
                                        totalpcs, ap_mn_x, 
                    ...
                    _cdfs2dA.smp_f(1, itr, M_use, yt0t1, clstsz, cls_str_ind, 
                                        v_sts, t0, l0, 
                                        totalpcs, ap_mn_y, 
                                        diff2_x, nrm_x, inv_sum_sd2s_x,
                                        diff2_y, nrm_y, inv_sum_sd2s_y,
                    ...
                    _cdfs2dA.smp_q2(0, itr, M_use, xt0t1, clstsz, cls_str_ind, 
                                    v_sts, t0, l0, 
                                    totalpcs, ap_sd2s_x,
                                    diff2_y, nrm_y, inv_sum_sd2s_y,
                                    diff2_x, nrm_x, inv_sum_sd2s_x,
                    ...
                    _cdfs2dA.smp_q2(1, itr, M_use, yt0t1, clstsz, cls_str_ind, 
                                    v_sts, t0, l0, 
                                    totalpcs, ap_sd2s_y,
                                    diff2_x, nrm_x, inv_sum_sd2s_x,
                                    diff2_y, nrm_y, inv_sum_sd2s_y,
