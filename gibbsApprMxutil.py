...
def declare_prior_hyp_params(M, MF, K, x, mks, Asts, t0):
    ...
    #  inverse gamma
    _q2_a   = _N.ones(M)*3.;    _q2_B  = _N.ones(M)*1e-3
...
def stochasticAssignment(oo, it, hashthresh, x, mks, M, K, l0, f, q2, u, Sg, _f_u, _u_u, Asts, t0, mASr, xASr, rat, econt, gz, qdrMKS, freeClstr, cmp2Existing):
...
def finish_epoch(oo, epc, ITERS, gz, l0, f, q2, u, Sg, _f_u, _f_q2, _q2_a, _q2_B, _l0_a, _l0_B, _u_u, _u_Sg, _Sg_nu, _Sg_PSI, smp_sp_hyps, smp_sp_prms, smp_mk_hyps, smp_mk_prms, freeClstr, M, K):
