    ...
    def gibbs(self, ITERS, K, ep1=0, ep2=None, savePosterior=True, gtdiffusion=False, Mdbg=None, doSepHash=True):
        ...
        for epc in xrange(ep1, ep2):
            ...
            if epc == ep1:   ###  initialize
                labS, labH, lab, flatlabels, M, MF = gAMxMu.initClusters(oo, K, x, mks, t0, t1, Asts, doSepHash=doSepHash)
            ...
            for iter in xrange(ITERS):
                ...
                gAMxMu.stochasticAssignment(oo, iter, M, K, l0, f, q2, u, Sg, Asts, t0, mASr, xASr, rat, econt, gz, qdrMKS, freeClstr, ((epc > 1) and (iter == 0)))
        #         ###############  FOR EACH CLUSTER
